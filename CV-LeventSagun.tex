...
\item Umut Simsekli, Levent Sagun, Mert Gurbuzbalaban. A Tail-Index Analysis of Stochastic Gradient Noise in Deep Neural Networks. Preprint, available at arXiv:1901.06053, 2019.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
\item An overview of empirical studies in neural networks, The Rough High-Dimensional Landscape Problem, KITP, Santa Barbara, January 2019 \\
